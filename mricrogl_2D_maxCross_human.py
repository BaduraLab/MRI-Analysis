...
for group_name in group_name_list:
    for subject_folder in subject_folder_list:
        ...
        for iRow in range(expSel_table.shape[0]):
            structureAcronym = expSel_table.iloc[iRow]['name']

            gl.loadimage(os.path.join(subject_folder, subject + '_reoriented.nii.gz'))
            ...
            for viewVal in [1, 2, 4]:
                ...
                if viewVal == 1:
                    print(f'z_center = [{z_center[0]}, {z_center[1]}, {z_center[2]}]')
                    ...
                    print(f'y_center = [{y_center[0]}, {y_center[1]}, {y_center[2]}]')
                    ...
                    print(f'x_center = [{x_center[0]}, {x_center[1]}, {x_center[2]}]')
