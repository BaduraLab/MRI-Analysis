...
for iMousePath, MousePath in enumerate(mouse_path_list):
    ...
    reference_template_path = os.path.join(MousePath, 'FLIRT', mouse_string + '_inmasked_flirted.nii.gz')
    ...
    flirtAffine_path = os.path.join(MousePath, 'flirtAffine.mat')
    template_flirtedRigid_path = os.path.join(MousePath, mouse_string + '_inmasked_flirtedRigid.nii.gz')
    annotation_flirtedRigid_path = os.path.join(MousePath, 'allen_annotation_invsynned_to_' + mouse_string + '_adjusted_cerebellum_lobular_flirtedRigid.nii.gz')
    flirtRigid_path = os.path.join(MousePath, 'flirtRigid.mat')
    ...
    print('FLIRT affine apply to template start')
    os.system('flirt -in ' + template_path + ' \
                     -ref ' + reference_template_path + ' \
