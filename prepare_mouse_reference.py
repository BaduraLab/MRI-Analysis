...
allen_template_path = os.path.join(reference_path, 'average_template_' + str(allen_res) + '_reoriented.nii.gz')
allen_template_flirtedRigid_path = os.path.join(reference_path, 'average_template_' + str(allen_res) + '_reoriented_flirtedRigid.nii.gz')
allen_template_flirted_path = os.path.join(reference_path, 'average_template_' + str(allen_res) + '_reoriented_flirted.nii.gz')
allen_template_flirtRigid_path = os.path.join(reference_path, 'average_template_' + str(allen_res) + '_reoriented_flirtRigid.mat')
allen_template_flirt_path = os.path.join(reference_path, 'average_template_' + str(allen_res) + '_reoriented_flirt.mat')
allen_template_flirted_synned_path = os.path.join(reference_path,
                                                  'average_template_' + str(allen_res) + '_reoriented_flirted_synned.nii.gz')
voxel_size = [allen_res/1000, allen_res/1000, allen_res/1000]

allen_annotation_path = os.path.join(reference_path, 'annotation_' + str(allen_res) + '_reoriented.nii.gz')
allen_annotation_flirtedRigid_path = os.path.join(reference_path, 'annotation_' + str(allen_res) + '_reoriented_flirtedRigid.nii.gz')
allen_annotation_flirted_path = os.path.join(reference_path, 'annotation_' + str(allen_res) + '_reoriented_flirted.nii.gz')
allen_annotation_flirted_synned_path = os.path.join(reference_path, 'annotation_' + str(allen_res) + '_reoriented_flirted_synned.nii.gz')

allen_structure_path = os.path.join(reference_path, 'structure_graph_mc.csv')
allen_template_flirted_syn_path = os.path.join(reference_path, 'average_template_' + str(allen_res) + '_reoriented_flirted_syn.pickle.gz')
forw_field_path = os.path.join(reference_path, 'average_template_' + str(allen_res) + '_reoriented_flirted_syn_forw.nii.gz')
back_field_path = os.path.join(reference_path, 'average_template_' + str(allen_res) + '_reoriented_flirted_syn_back.nii.gz')
...
# Reorient and downsample AMBMC atlas, the AMBMC annotation might not be downsampled correctly (NN)
print('reorientation')
correct_qform = nib.load(AMBMC_template_path).get_qform()
AMBMC_path_list = list()
for iPath, Path in enumerate([AMBMC_template_path] + AMBMC_annotation_path_list):
    print(Path)
    ...
    output_resampled_path = Path.split('.')[0] + '_' + str(allen_res) + '_reoriented.nii.gz'

    # Downsampling, for template use cubic and for annotation use NN interpolation
    if iPath == 0:
        output_resampled_image = nib_processing.resample_to_output(output_image, voxel_size, order=3)
    else:
        output_resampled_image = nib_processing.resample_to_output(output_image, voxel_size, order=0)
    print(f'Saving {output_resampled_path}')
...
AMBMC_template_zeropadded_path = AMBMC_template_path.split('.')[0]+'_zeropadded_10.nii.gz'
print(AMBMC_template_zeropadded_path)
print(f'Saving {AMBMC_template_zeropadded_path}')
...
# FLIRT allen to AMBMC -- in was allen_template_flirtedRigid_path
...
allen_template_flirted_cropped_path = allen_template_flirted_path.split('.')[0]+'_cropped_10.nii.gz'
print(allen_template_flirted_cropped_path)
print(f'Saving {allen_template_flirted_cropped_path}')
nib.save(allen_template_flirted_cropped_image, allen_template_flirted_cropped_path)
# allen template flirted cropping
allen_template_flirted_cropped, crop_index = zeroPadImage(allen_template_flirted, allen_template_flirted, 0.3)
allen_template_flirted_cropped_image = nib.Nifti1Image(allen_template_flirted_cropped, allen_template_flirted_image.affine)
allen_template_flirted_cropped_path = allen_template_flirted_path.split('.')[0]+'_cropped_30.nii.gz'
print(allen_template_flirted_cropped_path)
print(f'Saving {allen_template_flirted_cropped_path}')
nib.save(allen_template_flirted_cropped_image, allen_template_flirted_cropped_path)
# allen template flirted cropping
allen_template_flirted_cropped, crop_index = zeroPadImage(allen_template_flirted, allen_template_flirted, 0.5)
allen_template_flirted_cropped_image = nib.Nifti1Image(allen_template_flirted_cropped, allen_template_flirted_image.affine)
allen_template_flirted_cropped_path = allen_template_flirted_path.split('.')[0]+'_cropped_50.nii.gz'
print(allen_template_flirted_cropped_path)
print(f'Saving {allen_template_flirted_cropped_path}')
nib.save(allen_template_flirted_cropped_image, allen_template_flirted_cropped_path)
...
# print(f'Saving {allen_template_flirted_synned_path}')
...
# FLIRT (affine) allen annotation to AMBMC -- in was allen_annotation_flirtedRigid_path
os.system('flirt -in ' + allen_annotation_path + ' \
                 -ref ' + AMBMC_template_zeropadded_path + ' \
...
allen_annotation_flirted_cropped_path = allen_annotation_flirted_path.split('.')[0]+'_cropped_10.nii.gz'
print(allen_annotation_flirted_cropped_path)
print(f'Saving {allen_annotation_flirted_cropped_path}')
nib.save(allen_annotation_flirted_cropped_image, allen_annotation_flirted_cropped_path)
# allen template flirted cropping
allen_annotation_flirted_cropped, crop_index = zeroPadImage(allen_annotation_flirted, allen_template_flirted, 0.3)
allen_annotation_flirted_cropped_image = nib.Nifti1Image(allen_annotation_flirted_cropped, allen_annotation_flirted_image.affine)
allen_annotation_flirted_cropped_path = allen_annotation_flirted_path.split('.')[0]+'_cropped_30.nii.gz'
print(allen_annotation_flirted_cropped_path)
print(f'Saving {allen_annotation_flirted_cropped_path}')
nib.save(allen_annotation_flirted_cropped_image, allen_annotation_flirted_cropped_path)
# allen template flirted cropping
allen_annotation_flirted_cropped, crop_index = zeroPadImage(allen_annotation_flirted, allen_template_flirted, 0.5)
allen_annotation_flirted_cropped_image = nib.Nifti1Image(allen_annotation_flirted_cropped, allen_annotation_flirted_image.affine)
allen_annotation_flirted_cropped_path = allen_annotation_flirted_path.split('.')[0]+'_cropped_50.nii.gz'
print(allen_annotation_flirted_cropped_path)
print(f'Saving {allen_annotation_flirted_cropped_path}')
nib.save(allen_annotation_flirted_cropped_image, allen_annotation_flirted_cropped_path)
...
# print(f'Saving {allen_annotation_flirted_synned_path}')
