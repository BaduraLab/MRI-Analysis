...
# retransform human native annotation, flirtRigid, flirted
import os
import numpy as np
import glob
import datetime
...
reference_template_path = os.path.join(reference_path, 'standard', 'MNI152_T1_1mm_brain.nii.gz')
reference_template_image = nib.load(reference_template_path)
reference_template = reference_template_image.get_fdata()
...
for iSubjectPath, SubjectPath in enumerate(subject_path_list):
    ...
    # Define subject annotation paths
    annotation_path_list = [
        os.path.join(SubjectPath, subject_string + '_annotation_orsuit_thrarg.nii.gz'),
        os.path.join(SubjectPath, subject_string + '_annotation_subcortical_thrarg.nii.gz'),
        os.path.join(SubjectPath, subject_string + '_annotation_CerebrA_thrarg.nii.gz'),
